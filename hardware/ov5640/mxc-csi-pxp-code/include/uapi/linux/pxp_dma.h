...
/*
 * Private ioctl for the V4L2 PxP video node.
 * fb_index maps to /dev/fbN. Use -1 to restore automatic framebuffer
 * selection based on the platform default policy.
 */
...
#define PXP_IOC_V4L2_G_OUTPUT_FB \
	_IOR(PXP_IOC_MAGIC, 9, struct pxp_video_output_fb)
